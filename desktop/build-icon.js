// Generate a 512x512 PNG icon for electron-builder (auto-converted to .ico).
// No external deps — hand-rolled PNG encoder (RGBA), mirrors extension/build-icons.js.
...
const size = 512;
const png = pngFromRgba(makeRgba(size), size, size);
writeFileSync(join(outDir, "icon.png"), png);
console.log(`wrote icons/icon.png (${png.length} bytes, ${size}x${size})`);